...
temp = pd.concat([michigan_counties, ohio_counties], ignore_index=True)

states_data = temp[temp['date'] == "2020-07-03"]

# Drop everything but cases and fips
temp = states_data.drop(['date', 'county', 'state', 'deaths'], axis=1)
